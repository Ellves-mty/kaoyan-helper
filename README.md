...
当前版本：**v1.6** — 文本/图片/PDF 解题 + 英语整篇解析 + 知识点统计 + GitHub Gist 跨设备同步（含删除同步）全流程可用，已部署上线。
...
- **跨设备同步**：GitHub 私有 Gist 自动同步（手机/电脑/平板共用一份记录），启动自动拉取合并，支持手动立即同步；**删除也会同步**（软删除墓碑机制，其他设备自动删掉该记录）
